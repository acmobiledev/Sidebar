...
enum GlobalConstants {
    ...
    static let iconBorderWidth: CGFloat = 0.9
...
let statusBarH = getCurrentWindow().windowScene?.statusBarManager?.statusBarFrame.height   //UIApplication.shared.statusBarFrame.height
