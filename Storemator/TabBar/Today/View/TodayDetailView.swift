...
extension TodayDetailView {
    func constructUI() {
        ...
        containerView.anchorView(top: self.topAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, topPadding: 0, leftPadding: 0, bottomPadding: 0, rightPadding: 0, width: 0, height: 400)
        
        containerView.addSubview(detailImageView)
        detailImageView.frame = containerView.bounds
        
        self.addSubview(detailTextView)
        detailTextView.anchorView(top: self.containerView.bottomAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, topPadding: 20, leftPadding: 20, bottomPadding: 0, rightPadding: 20, width: 0, height: 0)

//        self.contentSize = CGSize(width: getCurrentWindow().bounds.width, height: containerView.frame.height + 20 + detailTextView.frame.height + 50)
    }
}
